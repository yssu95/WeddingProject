...
<script src="/resources/js/border/pager.js">
...
<body>
   ...
   <div id="mainWrapper">
      ...
      <div class="t1">
         ...
         <form action="/board/notices" method="get">
            <select name="sort">
                     ...
                     <table id="table" class="table table-hover table-mc-light-blue">
                        ...
                        <tbody>
                           ...
                           <c:forEach items="${notices}" var="notices">
                              <tr>
                                 <td><c:out value="${notices.no}" /></td>
                                 <td><c:out value="${notices.header}" /></td>
                                 <td >
                                 <a href="/board/noticesR?no=${notices.no}"><c:out value="${notices.title}"/>
                                 </a>
                                 </td>
                                 <td>관리자</td>
                                 <td>${notices.noticeDate}</td>
                                 <td><c:out value="${notices.hit}" /></td>
                              </tr>
                           </c:forEach>
               ...
               <div id="paging">
                  <ul class="pagination">
                     <c:if test="${pageMaker.prev}">
                        <li><a
                           href="notices${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
                     </c:if>
                     ...
                     <c:forEach begin="${pageMaker.startPage}"
                        ...
                        <li
                           ...
                           <a href="notices${pageMaker.makeSearch(idx)}">${idx}</a>
                        </li>
                     </c:forEach>

                     <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                        <li><a
                           href="notices${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
                     </c:if>
                  </ul>
               </div>
