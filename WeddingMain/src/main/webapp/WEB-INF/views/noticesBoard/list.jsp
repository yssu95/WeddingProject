							...
							<table id="table" class="table table-hover table-mc-light-blue">
								...
								<tbody>
									...
									<c:forEach items="${notices}" var="notices">
										<tr>
											<td data-title="no"><c:out value="${notices.no}" /></td>
											<td data-title="cate"><c:out value="${notices.header }" /></td>
											<td data-title="title">
													<a href="/qnaboard/readView?bno=${notices.no}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}">
														<c:out value="${notices.title}" /> 바보 바ㅗ바봐보바보바보바ㅗ바보바보
													</a>
													<a href="/qnaboard/needLogin"> 
													</a>
												</td>
											<!-- <td data-title="writer"><c:out value="${notices.writer}" /></td> -->
											<td data-title="date"><fmt:formatDate
													value="${notices.regdate}" pattern="yyyy-MM-dd" /></td>
											<td data-title="hit"><c:out value="${notices.hit}" /></td>
										</tr>
									</c:forEach>
