...
<div class="table_title table_mt">스냅/DVD 세부내용 등록</div>
				<table class="table_box">
					...
					<tbody>
						...
						<tr>
							<th><label for="shooting_step">촬영스탭</label></th>

							<td class="td_sec">
								<div class="inputArea shooting_step">
									<input type="text" id="shooting_step" name="shooting_step" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 30자)
									</span>
								</div>
						...
						<tr>
							<th><label for="shooting_eq">촬영장비</label></th>

							<td class="td_sec">
								<div class="inputArea shooting_eq">
									<input type="text" id="shooting_eq" name="shooting_eq" class="chk" /> <span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 50자)
									</span>
								</div>
						...
						<tr>
							<th><label for="runtime">러닝타임</label></th>

							<td class="td_sec">
						
								<div class="inputArea runtime">
									<input type="text" id="runtime" name="runtime" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 50자)
									</span>
								</div>
						...
						<tr>
							<th><label for="prod_proc">제작과정</label></th>

							<td class="td_sec">
								<div class="inputArea prod_proc">
									<input type="text" id="prod_proc" name="prod_proc" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 30자)
									</span>
								</div>
