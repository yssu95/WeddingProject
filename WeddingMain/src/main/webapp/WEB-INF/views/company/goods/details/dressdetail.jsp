...
<div class="table_title table_mt">드레스 세부내용 등록</div>
            <table class="table_box">
               ...
               <tbody>
                  ...
                  <tr>
                     <th><label for="d_type">드레스타입</label></th>

                     <td class="td_sec">
                        <div class="inputArea d_type">
                           <input type="text" id="d_type" name="d_type" class="chk" /><span
                              style="color: #666; font-weight: bold" id="counter">(<em>0</em>
                              / 최대 50자)
                           </span>
                        </div>
                  ...
                  <tr>
                     <th><label for="d_size">사이즈</label></th>

                     <td class="td_sec">
                        <div class="inputArea d_size">
                           <input type="text" id="d_size" name="d_size" class="chk" /><span
                              style="color: #666; font-weight: bold" id="counter">(<em>0</em>
                              / 최대 30자)
                           </span>
                        </div>
                  ...
                  <tr>
                     <th><label for="d_concept">드레스컨셉</label></th>

                     <td class="td_sec">
                        <div class="inputArea d_concept">
                           <input type="text" id="d_concept" name="d_concept" class="chk" /> <span
                              style="color: #666; font-weight: bold" id="counter">(<em>0</em>
                              / 최대 50자)
                           </span>
                        </div>
                  ...
                  <tr>
                     <th><label for="w_shoewh">웨딩슈즈</label></th>

                     <td class="td_sec">
                  
                        <div class="inputArea w_shoewh">
                           <input type="text" id="w_shoewh" name="w_shoewh" class="chk" /><span
                              style="color: #666; font-weight: bold" id="counter">(<em>0</em>
                              / 최대 50자)
                           </span>
                        </div>
                  ...
                  <tr>
                     <th><label for="as_wh">AS</label></th>
                  ...
                  <tr>
                     <th><label for="gdsDes">상세내용</label></th>
