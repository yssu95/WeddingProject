...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#rent_purch_method').keyup(
				function(e) {
					var content = $(this).val();
					$('.rent_purch_method > #counter').html(
							"(<em>" + content.length
									+ " </em> / 최대 30자)"); //글자수 실시간 카운팅
		...
		$('#retrun_collect_method').keyup(
				function(e) {
					var content = $(this).val();
					$('.retrun_collect_method > #counter').html(
							"(<em>" + content.length
...
<div class="table_title table_mt">한복 세부내용 등록</div>
				<table class="table_box">
					...
					<tbody>
						...
						<tr>
							<th><label for="rent_purch_method">대여구매방법</label></th>

							<td class="td_sec">
								<div class="inputArea rent_purch_method">
									<input type="text" id="rent_purch_method" name="rent_purch_method" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 30자)
									</span>
								</div>
						...
						<tr>
							<th><label for="retrun_collect_method">수령반납방법</label></th>

							<td class="td_sec">
								<div class="inputArea retrun_collect_method">
									<input type="text" id="retrun_collect_method" name="retrun_collect_method" class="chk" /> <span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 50자)
									</span>
								</div>
						...
						<tr>
							<th><label for="fitting_cost">피팅비</label></th>

							<td class="td_sec">
						
								<div class="inputArea fitting_cost">
									<input type="text" id="fitting_cost" name="fitting_cost" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 50자)
									</span>
								</div>
						...
						<tr>
							<th><label for="as_wh">A/S</label></th>

							<td class="td_sec">
								<div class="inputArea as_wh">
									<input type="text" id="as_wh" name="as_wh" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 30자)
									</span>
								</div>
