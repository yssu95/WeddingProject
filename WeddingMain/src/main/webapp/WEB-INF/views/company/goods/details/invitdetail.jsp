...
<div class="table_title table_mt">청첩장 세부내용 등록</div>
				<table class="table_box">
					...
					<tbody>
						...
						<tr>
							<th><label for="m_invit">모바일청첩장</label></th>

							<td class="td_sec">
						
								<div class="inputArea m_invit">
									<input type="text" id="m_invit" name="m_invit" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 50자)
									</span>
								</div>
						...
						<tr>
							<th><label for="i_concept">컨셉</label></th>

							<td class="td_sec">
								<div class="inputArea m_cost">
									<input type="text" id="i_concept" name="i_concept" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 30자)
									</span>
								</div>
