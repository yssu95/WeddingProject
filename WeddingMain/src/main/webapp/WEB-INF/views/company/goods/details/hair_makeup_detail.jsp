...
<div class="table_title table_mt">헤어/메이크업 세부내용 등록</div>
				<table class="table_box">
					...
					<tbody>
						...
						<tr>
							<th><label for="hair_ch">헤어담당</label></th>

							<td class="td_sec">
								<div class="inputArea hair_ch">
									<input type="text" id="hair_ch" name="hair_ch" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 50자)
									</span>
								</div>
						...
						<tr>
							<th><label for="makeup_ch">메이크업담당</label></th>

							<td class="td_sec">
								<div class="inputArea makeup_ch">
									<input type="text" id="makeup_ch" name="makeup_ch" class="chk" /> <span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 30자)
									</span>
								</div>
						...
						<tr>
							<th><label for="nailart_wh">네일아트</label></th>

							<td class="td_sec">
								<div class="inputArea nailart_wh">
									<input type="text" id="nailart_wh" name="nailart_wh" class="chk" /><span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 30자)
									</span>
								</div>
						...
						<tr>
							<th><label for="formula">방식</label></th>

							<td class="td_sec">
								<div class="inputArea formula">
									<input type="text" id="formula" name="formula" class="chk" /> <span
										style="color: #666; font-weight: bold" id="counter">(<em>0</em>
										/ 최대 50자)
									</span>
								</div>
