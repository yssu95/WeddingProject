...
<script type="text/javascript">
			...
			.ready(
					function() {
						...
						$(".update_btn").on("click", function() {
							formObj.attr("action", "/admin2/qna/updateView");
						...
						$(".replyWriteBtn").on("click", function() {
							...
							formObj.attr("action", "/admin2/qna/replyWrite");
							formObj.submit();
						});
						...
						$(".replyUpdateBtn")
								.on(
										"click",
										function() {
											location.href = "/admin2/qna/replyUpdateView?bno=${read.bno}"
													+ "&page=${scri.page}"
						...
						$(".replyDeleteBtn")
								.on(
										"click",
										function() {
											location.href = "/admin2/qna/replyDeleteView?bno=${read.bno}"
													+ "&page=${scri.page}"
													+ "&perPageNum=${scri.perPageNum}"
													+ "&searchType=${scri.searchType}"
													+ "&keyword=${scri.keyword}"
    ...
    function del(seq) {
        ...
        if (chk) {
            location.href='qnaDelete?bno='+seq;
        }
    }
</script>
<body>
    ...
    <div class="boardwrap">
        ...
        <div class="boardwrap3">
            ...
            <div class="row">
              <input type="submit" id="submit" value="삭제" onclick="del(${read.bno})">
              <input type="reset" id="reset" value="목록" onclick='location.href="/admin2/qna/qnaList"'>
			...
			<div class="col-12">
               ...
               <input type="hidden" id="keyword" name="keyword" value="${scri.keyword}">
								...
								<span class="commenter-name"> 
								 <input type="hidden" id="writer" name="writer" class="form-control" value="관리자" />
