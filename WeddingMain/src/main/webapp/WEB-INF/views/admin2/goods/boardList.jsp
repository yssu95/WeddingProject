                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="header">
                                    ...
                                    <p class="category">소소웨딩 고객님들께서 자유롭게 소통하는 게시판 입니다</p>
                                </div>
                                <div class="content table-responsive table-full-width">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><c:out value="${boardList.header }"/></td>
                                                    <td>
                                                        <a href="/admin2/goods/boardListR?bno=${boardList.bno}"><c:out value="${boardList.title}" /></a>
                                                    </td>
                                            <td>${boardList.writer}</td>
                                            <td><fmt:formatDate value="${boardList.regdate}" pattern="yyyy-MM-dd"/></td>
                                            <td data-title="hit"><c:out value="${boardList.hit}" /></td>
                                            <td>${boardList.reply_cnt}</td>
                                           <!--  <td><button type="button" value="삭제" onclick="del(${boardList.bno})">삭제</button></td> -->
                                        </tr>
                                        </c:forEach>
