			...
			.ready(
					function() {
						...
						$(".replyWriteBtn").on("click", function() {
							...
							formObj.attr("action", "/admin2/review/replyWrite");
							formObj.submit();
						});
						...
						$(".replyUpdateBtn")
								.on(
										"click",
										function() {
											location.href = "/admin2/review/replyUpdateView?bno=${read.bno}"
													+ "&page=${scri.page}"
						...
						$(".replyDeleteBtn")
								.on(
										"click",
										function() {
											location.href = "/admin2/review/replyDeleteView?bno=${read.bno}"
													+ "&page=${scri.page}"
													+ "&perPageNum=${scri.perPageNum}"
													+ "&searchType=${scri.searchType}"
													+ "&keyword=${scri.keyword}"
...
<body>
    ...
    <div class="boardwrap">
        ...
        <div class="boardwrap3">
            ...
            <div class="row">
              <input type="reset" id="submit" value="삭제" onclick="del(${read.bno})">
              <input type="reset" id="reset" value="목록" onclick='location.href="/admin2/review/"'>
            </div>
							...
							<div class="col-12">
							   ...
							   <input type="hidden" id="keyword" name="keyword" value="${scri.keyword}">
												...
												<input type="hidden"
													...
													value="관리자" /> <input type="text" id="content"
