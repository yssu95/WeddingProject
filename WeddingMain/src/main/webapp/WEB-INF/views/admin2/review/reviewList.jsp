                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="header">
                                    ...
                                    <p class="category">소소웨딩 고객님들의 소중한 후기입니다</p>
                                </div>
                                        ...
                                        <c:forEach items="${list}" var="list">
                                            <tr>
                                               ...
                                               <td data-title="title"><a
                                                  href="/admin2/review/readView?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}">
                                               ...
                                               <td><c:out value="${list.reply_cnt}" /></td>
                                            </tr>
				...
				<div id="paging">
					<ul class="pagination">
						<c:if test="${pageMaker.prev}">
							<li><a
								href="review${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
						</c:if>
						...
						<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
							<li><a
								href="review${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
						</c:if>
					</ul>
				</div>
			</div>
