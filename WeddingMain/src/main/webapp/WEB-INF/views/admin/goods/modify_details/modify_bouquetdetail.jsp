               ...
               <!-- 상세내용 -->
                <div class="inputArea">
                  <label for="prod_comp">상품구성</label> <input type="text"
                     id="prod_comp" name="prod_comp" value="${weddingvo.prod_comp}"/>
               </div>
                <div class="inputArea">
                  <label for="standard">규격</label> <input type="text"
                     id="standard" name="standard" value="${weddingvo.standard}"/>
               </div>
                <div class="inputArea">
                  <label for="mater">소재</label> <input type="text"
                     id="mater" name="mater" value="${weddingvo.mater}"/>
               </div>
                <div class="inputArea">
                  <label for="color">색상</label> <input type="text"
                     id="color" name="color" value="${weddingvo.color}"/>
               </div> 
               <div class="inputArea">
                  <label for="sale_ava_time">판매가능시기</label> <input type="text"
                     id="sale_ava_time" name="sale_ava_time" value="${weddingvo.sale_ava_time}"/>
               </div> 
