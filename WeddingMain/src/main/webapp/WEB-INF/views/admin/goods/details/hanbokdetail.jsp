...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   pageEncoding="UTF-8"%>
               ...
               <!-- 상세내용 -->
                ...
                <div class="inputArea">
                  <label for="rent_purch_method">대여구매방법</label> <input type="text"
                     id="rent_purch_method" name="rent_purch_method" />
               </div>
                <div class="inputArea">
                  <label for="retrun_collect_method">수령반납방법</label> <input type="text"
                     id="retrun_collect_method" name="retrun_collect_method" />
               </div>
                <div class="inputArea">
               ...
               <div class="inputArea">
                  <label for="as_wh">A/S</label> <input type="text"
                     id="as_wh" name="as_wh" />
               </div>                                          
